...
public class OdataPrimitiveProcessor implements PrimitiveProcessor {
	 ...
	 * http://localhost:8080/DemoService/DemoService.svc/Products(1)/Name and the
	 * response: {
	 * 
	...
	public void readPrimitive(ODataRequest request, ODataResponse response, UriInfo uriInfo, ContentType responseFormat)
		...
		List<UriParameter> keyParams = uriEntityset.getKeyPredicates();

		// 1.2. retrieve the requested (Edm) property
		UriResourceProperty uriProperty = (UriResourceProperty) resourceParts.get(resourceParts.size() - 1); // the last
																												// segment
																												// is
																												// the
																												// Property
